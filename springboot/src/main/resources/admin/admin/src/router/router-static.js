...
import center from '@/views/center'
    ...
    import chujiezhe from '@/views/modules/chujiezhe/list'
    import tushufenlei from '@/views/modules/tushufenlei/list'
    import jieyuezhe from '@/views/modules/jieyuezhe/list'
    import fankuixinxi from '@/views/modules/fankuixinxi/list'
    import chuzushouru from '@/views/modules/chuzushouru/list'
