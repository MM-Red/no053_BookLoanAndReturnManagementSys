...
public class TushujieyueController {
    ...
    public R page(@RequestParam Map<String, Object> params,TushujieyueEntity tushujieyue,
		...
		if(tableName.equals("jieyuezhe")) {
			tushujieyue.setJieyuezhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("chujiezhe")) {
			tushujieyue.setChujiezhanghao((String)request.getSession().getAttribute("username"));
		}
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("jieyuezhe")) {
			wrapper.eq("jieyuezhanghao", (String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("chujiezhe")) {
			wrapper.eq("chujiezhanghao", (String)request.getSession().getAttribute("username"));
		}
